...
import type { SampleWorkspaceVersion } from "@/lib/widgets/sample-workspaces";
import type {
  TableWidgetData,
  WorkspaceWidget,
...
export function WorkspaceCanvas({
  ...
  const [summary, setSummary] = useState(
    latestVersion?.summary ?? workspace.summary,
  );
            ...
            <div className="flex min-h-[220px] flex-col">
              ...
              <div className="mt-auto flex flex-col gap-2 pt-6 lg:flex-row lg:items-center lg:justify-end">
                {workspace.versions.length > 1 ? (
                  ...
                  >
                    <SelectTrigger className="h-10 w-full rounded-sm border-zinc-950/10 bg-[#f7f2ea] px-3 text-zinc-950 shadow-none lg:min-w-40 lg:w-auto">
            ...
            {isRefreshingWidgets ? (
              ...
              <WorkspaceWidgetRenderer
                ...
                onChecklistItemToggle={
                  canUpdate ? handleChecklistItemToggle : undefined
                }
                onPhaseStatusChange={
                  canUpdate ? handlePhaseStatusChange : undefined
                }
